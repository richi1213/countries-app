...
import styles from '@/pages/countries/components/list/card-wrapper/skeleton/CountryCardWrapperSkeleton.module.css';

const CountryCardWrapperSkeleton = () => {
  const skeletonItems = Array.from({ length: 25 }).map((_, index) => (
